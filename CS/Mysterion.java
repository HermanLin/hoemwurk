...
public class Mysterion 
{
	...
	for( int testC = 0; testC < 8; testC++ ) {
	    System.out.println("p1's magic nums:");
	    printArr(p1);
	    System.out.println(mysterion(p1,0,7,testC));
	    System.out.println("after mysterion w/ a=0,b=7,c=" 
			       + testC +"...");
	    printArr(p1);
	    System.out.println("-----------------------");
/*
	    ...
	    printArr(p3);
	    System.out.println(mysterion(p3,0,4,testC));
	    ...
	    printArr(p4);
	    System.out.println(mysterion(p4,0,4,testC));
	    System.out.println("after mysterion w/ a=0,b=4,c=" 
			       + testC +"...");
	    printArr(p4);
	    System.out.println("-----------------------");
	    ...
	    printArr(p5);
	    System.out.println(mysterion(p5,0,4,testC));
	    System.out.println("after mysterion w/ a=0,b=4,c=" 
			       + testC +"...");
	    printArr(p5);
	    System.out.println("-----------------------");
